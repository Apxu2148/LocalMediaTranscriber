...
class I18nTests(unittest.TestCase):
    def test_ru_en_dictionary_keys_match_and_default_language_is_preserved(self) -> None:
        ...
        for key in (
            ...
            "deleteModel",
            "defaultSuffix",
            "queueFolderNameLabel",
            "queueFolderNamePlaceholder",
            "queueFolderNameHelp",
            "queueFolderPath",
            "queueFolderPathPending",
            ...
            "estimateAudioUnavailableSummary",
            "estimateFramesSummary",
            "estimateOcrSummary",
            "estimateOcrUnavailableSummary",
            "estimateBreakdownHeading",
            "estimateTranscriptionBreakdown",
            "estimateAudioUnavailableBreakdown",
            "estimateFrameExtractionBreakdown",
            "estimateOcrBreakdown",
            "estimateOcrUnavailableBreakdown",
            "estimateTotalBreakdown",
            "estimateAudioConfig",
            "estimateFramesConfig",
            "estimateOcrExpectedFrames",
            "estimateOcrSampledFrames",
            "estimateOcrAveragePerFrame",
            "estimateOcrEngine",
            "estimateOcrFirstRunNote",
            "estimateAudioTotalExcluded",
            "estimateAudioUnavailable",
            "estimateAudioNoStream",
            "estimateOcrTotalExcluded",
            "estimateOcrUnavailable",
            "estimateOcrUnavailableEasyOcr",
            "estimateOcrUnsupportedBackend",
            "estimateOcrUnavailableEstimator",
            "estimateOcrUnavailableFrames",
            "estimateOcrUnavailableFailed",
            "sampleFrames",
            ...
            "queueFolderArtifactPath",
            "queueManifestArtifactPath",
            "queueItemFolderArtifactPath",
